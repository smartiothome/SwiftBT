...
- (void)scan
{
    [self.centralManager scanForPeripheralsWithServices:@[[CBUUID UUIDWithString:MYGROUP_SERVICE_UUID]]
...
/** This callback comes whenever a peripheral that is advertising the MYGROUP_SERVICE_UUID is discovered.
...
- (void)centralManager:(CBCentralManager *)central didConnectPeripheral:(CBPeripheral *)peripheral
{
    ...
    [peripheral discoverServices:@[[CBUUID UUIDWithString:MYGROUP_SERVICE_UUID]]];
}
