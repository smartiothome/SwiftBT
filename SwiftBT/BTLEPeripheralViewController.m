...
- (void)peripheralManagerDidUpdateState:(CBPeripheralManager *)peripheral
{
   ...
   // self.transferCharacteristic = [[CBMutableCharacteristic alloc] initWithType:[CBUUID UUIDWithString:TRANSFER_CHARACTERISTIC_UUID] properties:CBCharacteristicPropertyNotify value:nil permissions:CBAttributePermissionsReadable];
    ...
    // Then the service
    //CBMutableService *transferService = [[CBMutableService alloc] initWithType:[CBUUID UUIDWithString:MYGROUP_SERVICE_UUID] primary:YES];
...
- (IBAction)switchChanged:(id)sender
{
    if (self.advertisingSwitch.on) {
        ...
        [self.peripheralManager startAdvertising:@{ CBAdvertisementDataServiceUUIDsKey : @[[CBUUID UUIDWithString:MYGROUP_SERVICE_UUID]], CBAdvertisementDataIsConnectable: @NO }];
    }
